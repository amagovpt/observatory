...
export class TopThreePracticesComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.practices.A = orderBy(this.practices.A, ['n_pages', 'n_occurrences'], ['desc', 'desc']).slice(0, 3);
    this.practices.AA = orderBy(this.practices.AA, ['n_pages', 'n_occurrences'], ['desc', 'desc']).slice(0, 3);
    this.practices.AAA = orderBy(this.practices.AAA, ['n_pages', 'n_occurrences'], ['desc', 'desc']).slice(0, 3);
  }
